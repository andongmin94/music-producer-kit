...
def check(root: Path = ROOT) -> dict:
    ...
    return {'status': 'pass', 'version': manifest['version'], 'skills': len(skills),
            'upstream_modules_catalogued': sum(counts.values()), 'behavior_scenarios_defined': len(scenarios),
            'behavior_scenarios_executed': False, 'host_installation_verified': False,
            'live_verified': False, 'audio_reviewed': False}
